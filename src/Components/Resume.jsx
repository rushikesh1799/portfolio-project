        ...
        <article className="resume active" data-page="resume">
                    ...
                    <li className="timeline-item">
                        ...
                        <div className="timeline-text">
                            ...
                            <p>
                                ...
                                Completed 3 Data Migration Projects for client
                                DuPont.
                            </p>
                        </div>
                    </li>
                ...
                <ol className="timeline-list">
                    <li className="timeline-item">
                        ...
                        <p className="timeline-text">
                            Learnt Javascript, React Js, Typescript, Redux
                            Toolkit, Mongoose, Express and Node JS while working
            ...
            <section className="skill">
                ...
                <div className="skills">
                    ...
                    <ul className="skills-list content-card flex-row">
                        <div
                            className="text-primary tracking-wider text-lg"
                            title="Material UI"
                        >
                            Frontend
                        </div>
                        <div className="skill-box">
                            <div
                                className="text-primary text-xs p-2 bg-body"
                                title="HTML"
                            >
                                HTML
                            </div>
                            ...
                            <div
                                className="text-primary text-xs p-2 bg-body yellow-skills"
                                title="Javascript"
                            >
                                Javascript
                            </div>
                            <div
                                className="text-primary text-xs p-2 bg-body blue-skills"
                                title="React JS"
                            >
                                React Js
                            </div>
                            <div
                                className="text-primary text-xs p-2 bg-body green-skills"
                                title="Redux Toolkit"
                            >
                                Redux Toolkit
                            </div>
